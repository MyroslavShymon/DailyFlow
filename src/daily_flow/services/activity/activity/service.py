...
class ActivityService:
    ...
    async def upsert_activity(self, dto: UpsertActivityDTO) -> Activity:
        ...
        try:
            return await self._repo.upsert_activity(title=title, payload=values)
    ...
    async def delete_activity_by_title(self, title: str) -> int:
        ...
        try:
            return await self._repo.delete_activity_by_title(title=title)
    ...
    async def delete_activity_by_id(self, activity_id: int) -> int:
        ...
        try:
            return await self._repo.delete_activity_by_id(activity_id=activity_id)
        except (RepoError, SQLAlchemyError) as e:
            raise TemporaryError("Database error. Please try again.") from e
    ...
    async def get_activity_by_id(self, activity_id: int) -> Activity | None:
        ...
        try:
            return await self._repo.get_activity_by_id(activity_id)
        except (RepoError, SQLAlchemyError) as e:
            raise TemporaryError("Database error. Please try again.") from e
    ...
    async def get_activity_by_title(self, title: str) -> Activity | None:
        ...
        try:
            return await self._repo.get_activity_by_title(title)
        except (RepoError, SQLAlchemyError) as e:
            raise TemporaryError("Database error. Please try again.") from e

    async def get_all_activities(self) -> list[Activity]:
        try:
            return await self._repo.get_all_activities()
        except (RepoError, SQLAlchemyError) as e:
            raise TemporaryError("Database error. Please try again.") from e
