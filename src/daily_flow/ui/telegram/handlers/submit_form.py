...
from daily_flow.ui.telegram.constants.activity import (
    activity_category_mapping,
    activity_mapping,
    activity_usage_mapping,
    category_mapping,
)
from daily_flow.ui.telegram.constants.common_mood_log import (
    common_mood_log_mapping,
    tag_impact_mapping,
)
...
from daily_flow.ui.telegram.render.activity import (
    render_activity,
    render_activity_usage,
    render_assign_category_result,
    render_category,
)
...
from daily_flow.ui.telegram.render.сommon_mood_log import render_common_mood_log, render_tag_impact
...
def get_submit_form_mapping(db_container: Container):
    return {
        ...
        TAG_IMPACT_FORM: {
            ...
            "render_func": lambda saved, values: render_tag_impact(
                saved, str(values.get("day") or "—")
            ),
        },
...
async def submit_form_handler(
    callback: types.CallbackQuery, state: FSMContext, bot: Bot, db_container: Container
):
    data = callback.data
