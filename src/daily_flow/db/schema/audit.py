...
from sqlalchemy import JSON, Column, DateTime, Enum, Integer, Table, Text
...
ingest_run = Table(
    "ingest_run",
    metadata,
    Column("id", Integer, primary_key=True, comment="Unique identifier for the ingestion run"),
    Column(
        "dataset",
        Text,
        nullable=False,
    ...
    Column("source_path", Text, nullable=False, comment="System path or URL to the source file"),
    Column(
        "file_hash",
        Text,
        nullable=False,
