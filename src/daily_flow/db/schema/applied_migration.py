...
applied_migration = Table(
    "applied_migration",
    metadata,
    Column("id", Integer, primary_key=True, comment="Unique migration identifier"),
    Column("version", Integer, nullable=False, comment="Version of the project"),
    Column("migration_name", Text, nullable=False, comment="Name of the migration"),
    Column(
        "applied_at",
        DateTime,
        nullable=False,
