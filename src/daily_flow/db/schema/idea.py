...
sphere = Table(
    "sphere",
    metadata,
    Column("id", Integer, primary_key=True, comment="Unique sphere identifier."),
    Column(
        "name", Text, nullable=False, comment="Sphere name (e.g. 'career', 'startup', 'learning')."
    ),
    Column(
        "description",
        Text,
...
idea = Table(
    "idea",
    metadata,
    Column("id", Integer, primary_key=True, comment="Unique idea identifier."),
    Column("title", Text, nullable=False, comment="Short idea title."),
    Column("description", Text, nullable=True, comment="Explanation or details of the idea."),
    Column(
        "intent",
        Text,
        nullable=True,
    ...
    CheckConstraint(
        ...
        "'problem', 'solution', 'hypothesis', 'question', 'insight', 'todo'"
        ")",
        name="ck_idea_intent",
    ),
