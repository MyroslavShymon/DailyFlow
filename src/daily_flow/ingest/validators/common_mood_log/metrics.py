...
def get_common_mood_log_metrics(
    ...
    if basic_metrics["rows_total"] == 0:
        return cast(CommonMoodLogMetrics, {**basic_metrics, **basic_extra_metrics})
    ...
    return {
        **basic_metrics,
        ...
        "rows_with_no_optional_fields": get_count(
            CommonMoodLogValidationWarnings.NO_OPTIONAL_FIELDS
        ),
    }
